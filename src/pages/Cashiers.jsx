      ...
      <div className="bg-white rounded-md  border border-gray-200 p-5">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full border border-gray-100 rounded-md py-2 text-sm pl-10 pr-4 outline-none focus:ring-1 focus:ring-blue-400 focus:border-transparent transition"
            />
          </div>

          <button className="flex items-center justify-center gap-2 bg-blue-400  text-white px-4 py-2 rounded-md text-sm cursor-pointer">
            <PlusIcon size={18} />
            <span>Cashier</span>
          </button>
        </div>
        ...
        <div className="mt-6 overflow-x-auto">
          <table className="w-full border-collapse">
            <thead>
              <tr className="bg-gray-50 text-left text-gray-600 uppercase text-[11px]">
            ...
            <tbody>
              {data.map((c,idx)=>{
                ...
                <td className="p-3">
                 ...
                 <td colSpan={4} className="p-3 flex items-center gap-2 text-gray-500 text-sm">
