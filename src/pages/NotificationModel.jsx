...
function NotificationModel({onClose,message='New payment initiated of 300000 from John Doe'}) {
    const [isreaded,setisreaded]=useState(false)
  return (
    <div className='flex justify-center  md:justify-end'>
        <div  className=' py-6 px-3 m-4  border border-gray-200 animate-bounce-once w-full md:max-w-[400px]  rounded-xl fixed z-40 bg-gray-100 '>
           ...
           <div>
            ...
            <p className='text-[13px]  flex gap-3'><Bell size={20}/>{message}</p>
            </div>
            <div  >
