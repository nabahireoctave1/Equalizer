...
function Repayments() {
   ...
   let payer=[
        {names:"nabahire octave",loanid:"EQ234345",amount:"3000000",cashier:"steve lorent", date:"May 31,2025",status:'done'},
        {names:"nziza Dan",loanid:"EQ454345",amount:"6000000",cashier:"precious ishimwe", date:"May 31,2025",status:'done'},
        {names:"Ganza Emma",loanid:"EQ904345",amount:"7000000",cashier:"bugingo blaise", date:"May 31,2025",status:'done'},
        {names:"Cyusa Emma",loanid:"EQ474345",amount:"2000000",cashier:"nyandwi james", date:"May 31,2025",status:'done'},
        {names:"Keza Kemirembe Dyana",loanid:"EQ9734345",amount:"4000000",cashier:"Joel smith", date:"May 31,2025",status:'done'},
    ]
    ...
    return (
        <div className='p-2 md:p-4'>
            {/* Header: Wraps neatly into a column on mobile, converts to a row on larger screens */}
            <div className='flex flex-col md:flex-row gap-4 justify-between items-start md:items-center border-b pb-3 py-2 px-4 border-gray-200'>
                ...
                <div className='flex flex-wrap items-center gap-2 w-full md:w-auto'>
                    <span className='capitalize p-2 px-4 rounded-md text-sm cursor-pointer border border-gray-200 bg-white whitespace-nowrap'>may,31,2025</span>
                    <span className='flex capitalize gap-2 p-2 px-4 rounded-md text-sm cursor-pointer border border-gray-200 bg-white items-center whitespace-nowrap'>
            ...
            {/* Details Section: Overflow configuration guarantees clean horizontal swipe views on mobile devices */}
